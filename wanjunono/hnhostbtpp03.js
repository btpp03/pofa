...
# cf隧道相关设置
export TOK=${TOK:-'eyJhIjoiYmJmMDc4YjVkYjlhMzcwMmFiYTg3OGQyODYxMDUwMDciLCJ0IjoiYWUxOWYwMjgtN2FjNC00Njc4LThjN2QtYjg0ZDE5MGIyMTdiIiwicyI6Ik56bGlNRGRpWkRRdE9HTXpPUzAwTm1NNUxXRTVOR1V0TlRJM1pUQTJORGxtWldVNSJ9'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'hnhostbtpp03.btppone.hidns.vip'}
...
export NEZHA_KEY=${NEZHA_KEY:-'FUZN3lK8IdKXImn5lB'}
...
export SUB_NAME=${SUB_NAME:-'hnhost-btpp03'}
